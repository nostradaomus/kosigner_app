<template>
  <div class="relative inline-flex">
    ...
    >
      <img class="w-8 h-8 rounded-full" src="../images/placeholder.png" width="32" height="32" alt="User" />
      <div class="flex items-center truncate">
        <span class="truncate ml-2 mr-1 text-sm font-medium dark:text-slate-300 group-hover:text-slate-800 dark:group-hover:text-slate-200">Sunrise Apartments</span>
