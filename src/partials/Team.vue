<template>
  <section class="bg-slate-100">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-12 md:pt-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 font-playfair-display text-slate-800">We are fully distributed, which means you can join us whenever you want.</h2>
        </div>
    ...
    <!-- Images container -->
    <div class="-ml-28 -mr-28 mb-8 md:mb-16">
      <div class="max-w-[1652px] mx-auto flex items-center space-x-2 md:space-x-4">
        <div class="relative w-1/3" data-aos="fade-right">
          <img class="aspect-[3/2] object-cover" src="../images/team-01.jpg" width="540" height="360" alt="Team 01" />
          <div class="absolute inset-0 bg-gradient-to-r from-slate-100" aria-hidden="true"></div>
        </div>
        <div class="relative w-1/3" data-aos="fade">
          <img class="aspect-[3/2] object-cover" src="../images/team-02.jpg" width="540" height="360" alt="Team 02" />
        </div>
        <div class="relative w-1/3" data-aos="fade-left">
          <img class="aspect-[3/2] object-cover" src="../images/team-03.jpg" width="540" height="360" alt="Team 03" />
          <div class="absolute inset-0 bg-gradient-to-l from-slate-100" aria-hidden="true"></div>
        </div>
      </div>
    </div>
    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <!-- Line -->
        <div class="hidden md:block absolute top-0 left-1/2 -ml-px -mt-4 w-0.5 h-12 bg-slate-300" aria-hidden="true"></div>

        <!-- Locations -->
        <div class="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-16 items-start mb-12 md:mb-20">

          <!-- 1st Location -->
          <div class="h-full flex flex-col items-center text-center" data-aos="fade-up">
            <div class="inline-flex w-[62px] h-[62px] mb-4">
              <svg class="fill-blue-600" width="62" height="61" viewBox="0 0 62 61">
            ...
            <h4 class="h4 font-playfair-display text-slate-800 mb-2">Shangai</h4>
            <div class="grow text-slate-500 mb-2">
              Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
            </div>
            <div class="font-sm font-medium text-slate-800">14 open positions</div>
          </div>

          <!-- 2nd Location -->
          <div class="h-full flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay="100">
            <div class="inline-flex w-[62px] h-[62px] mb-4">
              <svg class="fill-blue-600" width="60" height="61" viewBox="0 0 60 61">
            ...
            <h4 class="h4 font-playfair-display text-slate-800 mb-2">London</h4>
            <div class="grow text-slate-500 mb-2">
              Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
            </div>
            <div class="font-sm font-medium text-slate-800">7 open positions</div>
          </div>

          <!-- 3rd Location -->
          <div class="h-full flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay="200">
            <div class="inline-flex w-[62px] h-[62px] mb-4">
              <svg class="fill-blue-600" width="62" height="62" viewBox="0 0 62 62">
            ...
            <h4 class="h4 font-playfair-display text-slate-800 mb-2">Washington D.C</h4>
            <div class="grow text-slate-500 mb-2">
              Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
            </div>
            <div class="font-sm font-medium text-slate-800">24 open positions</div>
          </div>
        ...
        <div class="text-center">
          <button class="btn text-white bg-blue-600 hover:bg-blue-700 group">
            See Open Positions <span class="tracking-normal text-blue-300 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
          </button>
        </div>
