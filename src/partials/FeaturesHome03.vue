<template>
  <section class="relative">
    ...
    <!-- Dark background -->
    <div class="absolute inset-0 bg-slate-900 pointer-events-none [clip-path:polygon(0_0,_5760px_0,_5760px_calc(100%_-_352px),_0_100%)] h-96 md:h-auto md:mb-64" aria-hidden="true"></div>
    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 font-playfair-display text-slate-100">A better home and unlimited new tenants in less than ten minutes</h2>
        </div>
        ...
        <div class="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-10 md:gap-y-10 items-start">
          ...
          <article data-aos="fade-up">
            <router-link class="relative block group mt-8 mb-4" to="#0">
              ...
              <div class="overflow-hidden">
                <img class="w-full aspect-square object-cover group-hover:scale-105 transition duration-700 ease-out" src="../images/features-home-3-01.jpg" width="342" height="342" alt="News 01" />
              </div>
              <div class="w-16 h-16 absolute bg-gradient-to-b from-blue-500 to-blue-600 rounded-full -top-8 left-8">
                <svg class="w-16 h-16 fill-current" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                  <path class="text-white" d="m30.152 39.848.672-.408C32.24 33.632 33.92 32 35.96 26.768a10.714 10.714 0 0 0-.432-2.28c-.288-.096-.888-.336-1.44-.336-1.776.48-3.48 1.632-5.208 2.088-1.272.336-.576 2.352.36 3.312.672-.384 1.872-1.008 2.28-.96-1.248 2.112-3 6.12-3 7.704 0 .528-.48.816-.48 1.104 0 .288.12.6.144.936.384-.24.48-.12.48.264.264.192.672.504 1.032.816.144-.744.384-1.56.888-1.464l-.6 1.704c.072.072.12.144.168.192Z" />
                </svg>
              </div>
            </router-link>
            <h3 class="h4 font-playfair-display mb-2">
              <router-link class="text-slate-800 hover:underline hover:decoration-blue-100" to="#0">Advanced Features</router-link>
            </h3>
            <p class="text-lg text-slate-500">Lorem ipsum is placeholder text used in the graphic, print, and publishing for previewing layouts.</p>
          </article>
