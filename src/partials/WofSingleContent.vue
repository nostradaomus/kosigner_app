      ...
      <div class="py-12 md:pt-20 md:pb-16">
        ...
        <div class="max-w-3xl mx-auto">
          <div class="text-lg text-slate-500">
            <h2 class="h3 font-playfair-display text-slate-800 mb-4">About Black Inc.</h2>
            <p class="mb-8">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum. Neque sodales ut etiam sit amet how to manage <a class="font-medium text-blue-600 hover:underline" href="#0">Black Inc.</a> malesuada proin libero nunc consequat interdum varius. Quam pellentesque nec nam aliquam sem et tortor consequat. Pellentesque adipiscing commodo elit at imperdiet. Semper auctor neque vitae tempus quam pellentesque nec. Amet dictum sit amet justo donec enim diam. Varius sit amet mattis vulputate enim nulla aliquet porttitor. Odio pellentesque diam volutpat commodo sed. Elit sed vulputate mi sit amet mauris commodo quis imperdiet.
            </p>
            <div class="flex justify-center mb-8" aria-hidden="true">
              <svg class="fill-slate-400" width="36" height="4">
                <circle cx="18" cy="2" r="2" />
                <circle cx="2" cy="2" r="2" />
                <circle cx="34" cy="2" r="2" />
              </svg>
            </div>
            <h3 class="flex h4 font-playfair-display text-slate-800 mb-4 lg:-ml-10">
              <div class="mr-5 mt-2">
                <svg class="fill-blue-600 shrink-0" width="20" height="16" viewBox="0 0 20 16">
            ...
            <h2 class="h3 font-playfair-display text-slate-800 mb-4">Conclusion</h2>
            <p class="mb-8">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum. Neque sodales ut etiam sit amet how to manage <a class="font-medium text-blue-600 hover:underline" href="#0">Black Inc.</a> Varius sit amet mattis vulputate enim nulla aliquet porttitor. Odio pellentesque diam volutpat commodo.
            </p>
          </div>
        </div>
