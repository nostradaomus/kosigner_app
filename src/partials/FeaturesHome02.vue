    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20 border-t border-slate-200">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 font-gt-america text-slate-800">How we make a difference for you</h2>
        </div>

        <!-- Section content -->
        <div class="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:items-start md:space-x-8 lg:space-x-16 xl:space-x-18 space-y-8 space-y-reverse md:space-y-0">
          ...
          <div class="md:w-7/12 lg:w-1/2" data-aos="fade-up">
            <div class="mb-8 text-center md:text-left">
              <h3 class="h3 text-slate-800 font-playfair-display mb-3">Evidence Based Coverage</h3>
              <p class="text-xl text-slate-500">Our risk model uses up-to-date research to identify tenants who possess traits that successfully reintegrated community members tend to have in common.</p>
            </div>
            <!-- Tabs buttons -->
            <div class="mb-8 md:mb-0">
              <button :class="tab !== 1 ? 'border-transparent opacity-50 hover:opacity-75' : 'border-2 border-teal-500 opacity-100'" class="flex items-start text-left bg-white border-2 px-5 py-3 rounded shadow-md transition duration-300 ease-in-out mb-3" @click="tab = 1">
                <svg class="w-4 h-4 fill-current text-teal-600 shrink-0 mt-1 mr-4" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <div class="text-slate-800 font-medium mb-1">Who is eligible for approval?</div>
              ...
              <button :class="tab !== 2 ? 'border-transparent opacity-50 hover:opacity-75' : 'border-2 border-teal-500 opacity-100'" class="flex items-start text-left bg-white border-2 px-5 py-3 rounded shadow-md transition duration-300 ease-in-out mb-3" @click="tab = 2">
                <svg class="w-4 h-4 fill-current text-teal-600 shrink-0 mt-1 mr-4" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <div class="text-slate-800 font-medium mb-1">How does the coverage work?</div>
                  <div class="text-slate-500">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur velit.</div>
                </div>
              </button>
              <button :class="tab !== 3 ? 'border-transparent opacity-50 hover:opacity-75' : 'border-2 border-teal-500 opacity-100'" class="flex items-start text-left bg-white border-2 px-5 py-3 rounded shadow-md transition duration-300 ease-in-out" @click="tab = 3">
                <svg class="w-4 h-4 fill-current text-teal-600 shrink-0 mt-1 mr-4" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <div class="text-slate-800 font-medium mb-1">What does the coverage guarantee?</div>
                  <div class="text-slate-500">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur velit.</div>
                </div>
              </button>
            </div>
